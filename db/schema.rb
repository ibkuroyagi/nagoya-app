...
ActiveRecord::Schema.define(version: 2019_12_02_041526) do
  ...
  create_table "team_universities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["team_id"], name: "index_team_universities_on_team_id"
  ...
  add_foreign_key "team_universities", "teams"
  add_foreign_key "team_universities", "universities"
end
